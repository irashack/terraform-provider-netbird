...
- `access_groups` (List of String) IDs of the groups whose peers may reach a private service over the tunnel
...
- `private` (Boolean) Whether the service is reachable only over NetBird, by peers in `access_groups`
