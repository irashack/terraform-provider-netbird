...
- `skip_auto_apply` (Boolean) Indicate if this exit node route (0.0.0.0/0) should skip auto-application for client routing. If omitted, the value on the server is kept.
